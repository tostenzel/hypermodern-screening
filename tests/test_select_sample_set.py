"""Tests for module `select_sample_sets.py`.
...
def test_select_trajectories_1() -> None:
    """Select combination with largest aggregate distance.
    ...
    The difference between sample and selection size is not large enough for high
    trust.
...
def test_select_trajectories_2(dist_matrix: np.ndarray) -> None:
    """Select combination with largest aggregate distance.
...
def test_select_trajectories_3(dist_matrix: np.ndarray) -> None:
    """Select combination with largest aggregate distance.
...
def test_select_trajectories_iteration_1() -> None:
    """Reduce sample set by one sample.
...
def traj_selection(sample_traj_list: List[np.ndarray], numbers: List[int]) -> List:
    ...
    """
    select_list, select_distance_matrix, _ = campolongo_2007(
...
def test_compare_camp_07_int_ge_men_14_2(
    ...
    """[1] and first improvements in [2] produce similar results.
...
def test_compare_camp_07_final_ge_men_14_2(
    ...
    """[1] and both improvements in [2] produce similar results.
...
def test_compare_camp_07_int_ge_men_14_1(
    ...
    """[1] and first improvements in [2] produce same results.
...
def test_compare_camp_07_final_ge_men_14_1(
    ...
    """[1] and both improvements in [2] produce same results.
